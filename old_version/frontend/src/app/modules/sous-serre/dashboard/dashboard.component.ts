...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild('hourChart') hourChartContainer: ElementRef;
  ...
  initHourChart(): void {
    if (this.hourChartContainer) {
      const chart = echarts.init(this.hourChartContainer.nativeElement);
      const option = {
        series: [
          {
            name: 'hour',
